	...
	public static class FarmersDelightAdvancements implements AdvancementSubProvider {
		...
		public void generate(HolderLookup.Provider p_255901_, Consumer<Advancement> consumer) {
			...
			Advancement cropRotation = getAdvancement(dippingYourRoots, ModItems.CABBAGE.get(), "plant_all_crops", FrameType.CHALLENGE, true, true, false)
					...
					.addCriterion("tomato", PlacedBlockTrigger.TriggerInstance.placedBlock(ModBlocks.BUDDING_TOMATO_CROP.get()))
					...
					.addCriterion("kelp", PlacedBlockTrigger.TriggerInstance.placedBlock(Blocks.KELP))
