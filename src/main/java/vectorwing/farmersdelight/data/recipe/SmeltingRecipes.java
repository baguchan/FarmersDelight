...
public class SmeltingRecipes
{
	public static void register(Consumer<FinishedRecipe> consumer) {
		...
		SimpleCookingRecipeBuilder.generic(Ingredient.of(ModItems.WHEAT_DOUGH.get()), RecipeCategory.FOOD,
		...
		SimpleCookingRecipeBuilder.generic(Ingredient.of(ModItems.HAM.get()), RecipeCategory.FOOD,
	...
	private static void foodSmeltingRecipes(String name, ItemLike ingredient, ItemLike result, float experience, Consumer<FinishedRecipe> consumer) {
		...
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(ingredient), RecipeCategory.FOOD,
				...
				.save(consumer);
		SimpleCookingRecipeBuilder.generic(Ingredient.of(ingredient), RecipeCategory.FOOD,
